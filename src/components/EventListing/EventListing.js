        ...
        <div className={styles.eventDetailContainer}>
          {this.props.eventData &&
            Object.entries(this.props.eventData).map((item) =>
              item[1].event_details.event_name.startsWith(
                ...
                <div key={item[0]} className={styles.innerCardContainer}>
                  ...
                  <div className={styles.imageAndDetails}>
                    ...
                    <span className={styles.otherDetails}>
                      ...
                      <p>Seats Available: {item[1].event_details.no_of_seats_available}</p>
                      {(item[1].event_details.no_of_seats_available > 0) ?
                        <button className={styles.eventListingButtons} onClick={(e, eventId) => {this.bookNowButtonHandler(e, item[0])}}>
                          Book Now
                        </button> :
